...
#ifndef CONDOR_CRYPTO_AES128_H
#define CONDOR_CRYPTO_AES128_H
...
class Condor_Crypt_AES128 : public Condor_Crypt_Base {

 public:
    Condor_Crypt_AES128(const KeyInfo& key);
    //------------------------------------------
 ...
 private:
    ...
    //------------------------------------------
    // ZKMZKM
    // TODO: replace with AES key structure
