...
// ZKMZKM
// TODO:
// Update with calls to EVP layer.  Right now this object is just a placeholder
// that was copied from the 3DES code.


Condor_Crypt_AES128 :: Condor_Crypt_AES128(const KeyInfo& key)
#if !defined(SKIP_AUTHENTICATION)
    : Condor_Crypt_Base(CONDOR_AES128, key)
{
    KeyInfo k(key);
...
Condor_Crypt_AES128 :: ~Condor_Crypt_AES128()
{
}

void Condor_Crypt_AES128:: resetState()
{
     memset(ivec_, 0, 8);
     num_=0;
}

bool Condor_Crypt_AES128 :: encrypt(unsigned char *  input, 
                                  int              input_len, 
...
bool Condor_Crypt_AES128 :: decrypt(unsigned char *  input, 
                                  int              input_len, 
                                  unsigned char *& output, 
                                  int&             output_len)
{
